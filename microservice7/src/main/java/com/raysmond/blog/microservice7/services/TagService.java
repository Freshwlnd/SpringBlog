...
import com.raysmond.blog.microservice7.client.TagRepositoryClient;
...
public class TagService {
    private TagRepositoryClient tagRepository;
    ...
    @Autowired
    public TagService(TagRepositoryClient tagRepository) {
