...
public class AdminController {
    ...
    public String testTest() {
        String mainUri = appSetting.getMainUri();
    ...
    @RequestMapping(value = "testSettings", method = RequestMethod.GET)
    @ResponseBody
    ...
    @RequestMapping(value = "testUpdateSettings", method = RequestMethod.GET)
    @ResponseBody
