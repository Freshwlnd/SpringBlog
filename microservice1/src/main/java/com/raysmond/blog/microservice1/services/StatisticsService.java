...
import com.raysmond.blog.common.models.StatisticsServiceParams;
...
public class StatisticsService {
    ...
    @RequestMapping(value = "/getVisitsStats", method = RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value = "/getVisitsStatsByPeriodAndPostsList", method = RequestMethod.POST)
    @ResponseBody
    public List<Object> getVisitsStatsByPeriodAndPostsList(@RequestBody StatisticsServiceParams statisticsServiceParams) {
        Date periodStart = statisticsServiceParams.getPeriodStart();
        Date periodEnd = statisticsServiceParams.getPeriodEnd();
        List<Integer> postsIdList = statisticsServiceParams.getPostsIdList();
        return getVisitsStatsByPeriodAndPostsList(periodStart, periodEnd, postsIdList);
    }
    ...
    @RequestMapping(value = "/convertDataToChart", method = RequestMethod.POST)
    @ResponseBody
    private VisitsStatsChartDTO convertDataToChart(@RequestBody List<Object> list) {
    ...
    @RequestMapping(value = "/getFullVisitsStatsChartData", method = RequestMethod.GET)
    @ResponseBody
    ...
    @RequestMapping(value = "/getChartDataByPeriodAndPostsList", method = RequestMethod.POST)
    @ResponseBody
    public VisitsStatsChartDTO getChartDataByPeriodAndPostsList(@RequestBody StatisticsServiceParams statisticsServiceParams) {
        Date periodStart = statisticsServiceParams.getPeriodStart();
        Date periodEnd = statisticsServiceParams.getPeriodEnd();
        List<Integer> postsIdList = statisticsServiceParams.getPostsIdList();
        return getChartDataByPeriodAndPostsList(periodStart, periodEnd, postsIdList);
    }
    ...
    public String testCPU(@RequestParam(name = "method", defaultValue = "all") String method) {
        ...
        switch (method) {
            ...
            case "getVisitsStats":
                getVisitsStats_test();
                break;
            case "getVisitsStatsByPeriodAndPostsList":
                getVisitsStatsByPeriodAndPostsList_test(start, end, postsIdList);
                break;
            case "convertDataToChart":
                convertDataToChart_test(list);
                break;
            case "getFullVisitsStatsChartData":
                getFullVisitsStatsChartData_test();
                break;
            case "getChartDataByPeriodAndPostsList":
                getChartDataByPeriodAndPostsList_test(start, end, postsIdList);
                break;
        }
